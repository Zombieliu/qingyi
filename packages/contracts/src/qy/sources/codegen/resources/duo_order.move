  ...
  module qy::duo_order { 
    ...
    const TABLE_NAME: vector<u8> = b"duo_order";
    const OFFCHAIN: bool = false;

    public(package) fun register_table(_dapp_hub: &mut DappHub, _ctx: &mut TxContext) {
    }

    public struct DuoOrder has copy, drop, store {
        user: address,
        companion_a: address,
        companion_b: address,
        rule_set_id: u64,
    ...
    public fun new(user: address, companion_a: address, companion_b: address, rule_set_id: u64, service_fee: u64, deposit_per_companion: u64, platform_fee_bps: u64, status: u8, team_status: u8, created_at: u64, finish_at: u64, dispute_deadline: u64, vault_service: u64, vault_deposit_a: u64, vault_deposit_b: u64, evidence_hash: vector<u8>, dispute_status: u8, resolved_by: address, resolved_at: u64): DuoOrder {
        DuoOrder {
            user,
            companion_a,
            companion_b,
    ...
    public fun user(self: &DuoOrder): address {
        self.user
    }

    public fun companion_a(self: &DuoOrder): address {
        self.companion_a
    }

    public fun companion_b(self: &DuoOrder): address {
        self.companion_b
    }

    public fun rule_set_id(self: &DuoOrder): u64 {
        self.rule_set_id
    }

    public fun service_fee(self: &DuoOrder): u64 {
        self.service_fee
    }

    public fun deposit_per_companion(self: &DuoOrder): u64 {
        self.deposit_per_companion
    }

    public fun platform_fee_bps(self: &DuoOrder): u64 {
        self.platform_fee_bps
    }

    public fun status(self: &DuoOrder): u8 {
        self.status
    }

    public fun team_status(self: &DuoOrder): u8 {
        self.team_status
    }

    public fun created_at(self: &DuoOrder): u64 {
        self.created_at
    }

    public fun finish_at(self: &DuoOrder): u64 {
        self.finish_at
    }

    public fun dispute_deadline(self: &DuoOrder): u64 {
        self.dispute_deadline
    }

    public fun vault_service(self: &DuoOrder): u64 {
        self.vault_service
    }

    public fun vault_deposit_a(self: &DuoOrder): u64 {
        self.vault_deposit_a
    }

    public fun vault_deposit_b(self: &DuoOrder): u64 {
        self.vault_deposit_b
    }

    public fun evidence_hash(self: &DuoOrder): vector<u8> {
        self.evidence_hash
    }

    public fun dispute_status(self: &DuoOrder): u8 {
        self.dispute_status
    }

    public fun resolved_by(self: &DuoOrder): address {
        self.resolved_by
    }

    public fun resolved_at(self: &DuoOrder): u64 {
        self.resolved_at
    }

    public fun update_user(self: &mut DuoOrder, user: address) {
        self.user = user
    }

    public fun update_companion_a(self: &mut DuoOrder, companion_a: address) {
        self.companion_a = companion_a
    }

    public fun update_companion_b(self: &mut DuoOrder, companion_b: address) {
        self.companion_b = companion_b
    }

    public fun update_rule_set_id(self: &mut DuoOrder, rule_set_id: u64) {
        self.rule_set_id = rule_set_id
    }

    public fun update_service_fee(self: &mut DuoOrder, service_fee: u64) {
        self.service_fee = service_fee
    }

    public fun update_deposit_per_companion(self: &mut DuoOrder, deposit_per_companion: u64) {
        self.deposit_per_companion = deposit_per_companion
    }

    public fun update_platform_fee_bps(self: &mut DuoOrder, platform_fee_bps: u64) {
        self.platform_fee_bps = platform_fee_bps
    }

    public fun update_status(self: &mut DuoOrder, status: u8) {
        self.status = status
    }

    public fun update_team_status(self: &mut DuoOrder, team_status: u8) {
        self.team_status = team_status
    }

    public fun update_created_at(self: &mut DuoOrder, created_at: u64) {
        self.created_at = created_at
    }

    public fun update_finish_at(self: &mut DuoOrder, finish_at: u64) {
        self.finish_at = finish_at
    }

    public fun update_dispute_deadline(self: &mut DuoOrder, dispute_deadline: u64) {
        self.dispute_deadline = dispute_deadline
    }

    public fun update_vault_service(self: &mut DuoOrder, vault_service: u64) {
        self.vault_service = vault_service
    }

    public fun update_vault_deposit_a(self: &mut DuoOrder, vault_deposit_a: u64) {
        self.vault_deposit_a = vault_deposit_a
    }

    public fun update_vault_deposit_b(self: &mut DuoOrder, vault_deposit_b: u64) {
        self.vault_deposit_b = vault_deposit_b
    }

    public fun update_evidence_hash(self: &mut DuoOrder, evidence_hash: vector<u8>) {
        self.evidence_hash = evidence_hash
    }

    public fun update_dispute_status(self: &mut DuoOrder, dispute_status: u8) {
        self.dispute_status = dispute_status
    }

    public fun update_resolved_by(self: &mut DuoOrder, resolved_by: address) {
        self.resolved_by = resolved_by
    }

    public fun update_resolved_at(self: &mut DuoOrder, resolved_at: u64) {
    ...
    public fun get_companion_a(dapp_hub: &DappHub, resource_account: String, order_id: u64): address {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = dapp_system::get_field<DappKey>(dapp_hub, resource_account, key_tuple, 1);
        let mut bsc_type = sui::bcs::new(value);
        let companion_a = sui::bcs::peel_address(&mut bsc_type);
        companion_a
    }

    public(package) fun set_companion_a(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, companion_a: address, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = to_bytes(&companion_a);
        dapp_system::set_field(dapp_hub, dapp_key::new(), resource_account, key_tuple, 1, value, ctx);
    }

    public fun get_companion_b(dapp_hub: &DappHub, resource_account: String, order_id: u64): address {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = dapp_system::get_field<DappKey>(dapp_hub, resource_account, key_tuple, 2);
        let mut bsc_type = sui::bcs::new(value);
        let companion_b = sui::bcs::peel_address(&mut bsc_type);
        companion_b
    }

    public(package) fun set_companion_b(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, companion_b: address, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = to_bytes(&companion_b);
    ...
    public fun get_deposit_per_companion(dapp_hub: &DappHub, resource_account: String, order_id: u64): u64 {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = dapp_system::get_field<DappKey>(dapp_hub, resource_account, key_tuple, 5);
        let mut bsc_type = sui::bcs::new(value);
        let deposit_per_companion = sui::bcs::peel_u64(&mut bsc_type);
        deposit_per_companion
    }

    public(package) fun set_deposit_per_companion(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, deposit_per_companion: u64, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = to_bytes(&deposit_per_companion);
    ...
    public fun get_team_status(dapp_hub: &DappHub, resource_account: String, order_id: u64): u8 {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = dapp_system::get_field<DappKey>(dapp_hub, resource_account, key_tuple, 8);
        let mut bsc_type = sui::bcs::new(value);
        let team_status = sui::bcs::peel_u8(&mut bsc_type);
        team_status
    }

    public(package) fun set_team_status(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, team_status: u8, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = to_bytes(&team_status);
    ...
    public fun get_vault_deposit_a(dapp_hub: &DappHub, resource_account: String, order_id: u64): u64 {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = dapp_system::get_field<DappKey>(dapp_hub, resource_account, key_tuple, 13);
        let mut bsc_type = sui::bcs::new(value);
        let vault_deposit_a = sui::bcs::peel_u64(&mut bsc_type);
        vault_deposit_a
    }

    public(package) fun set_vault_deposit_a(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, vault_deposit_a: u64, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = to_bytes(&vault_deposit_a);
        dapp_system::set_field(dapp_hub, dapp_key::new(), resource_account, key_tuple, 13, value, ctx);
    }

    public fun get_vault_deposit_b(dapp_hub: &DappHub, resource_account: String, order_id: u64): u64 {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = dapp_system::get_field<DappKey>(dapp_hub, resource_account, key_tuple, 14);
        let mut bsc_type = sui::bcs::new(value);
        let vault_deposit_b = sui::bcs::peel_u64(&mut bsc_type);
        vault_deposit_b
    }

    public(package) fun set_vault_deposit_b(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, vault_deposit_b: u64, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = to_bytes(&vault_deposit_b);
    ...
    public fun get_dispute_status(dapp_hub: &DappHub, resource_account: String, order_id: u64): u8 {
        ...
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = dapp_system::get_field<DappKey>(dapp_hub, resource_account, key_tuple, 16);
        let mut bsc_type = sui::bcs::new(value);
    ...
    public(package) fun set_dispute_status(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, dispute_status: u8, ctx: &mut TxContext) {
        ...
        dapp_system::set_field(dapp_hub, dapp_key::new(), resource_account, key_tuple, 16, value, ctx);
    }
    ...
    public fun get_resolved_by(dapp_hub: &DappHub, resource_account: String, order_id: u64): address {
        ...
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = dapp_system::get_field<DappKey>(dapp_hub, resource_account, key_tuple, 17);
        let mut bsc_type = sui::bcs::new(value);
    ...
    public(package) fun set_resolved_by(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, resolved_by: address, ctx: &mut TxContext) {
        ...
        dapp_system::set_field(dapp_hub, dapp_key::new(), resource_account, key_tuple, 17, value, ctx);
    }
    ...
    public fun get_resolved_at(dapp_hub: &DappHub, resource_account: String, order_id: u64): u64 {
        ...
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value = dapp_system::get_field<DappKey>(dapp_hub, resource_account, key_tuple, 18);
        let mut bsc_type = sui::bcs::new(value);
    ...
    public(package) fun set_resolved_at(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, resolved_at: u64, ctx: &mut TxContext) {
        ...
        dapp_system::set_field(dapp_hub, dapp_key::new(), resource_account, key_tuple, 18, value, ctx);
    }

    public fun get(dapp_hub: &DappHub, resource_account: String, order_id: u64): (address, address, address, u64, u64, u64, u64, u8, u8, u64, u64, u64, u64, u64, u64, vector<u8>, u8, address, u64) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        ...
        let resolved_by = sui::bcs::peel_address(&mut bsc_type);
        let resolved_at = sui::bcs::peel_u64(&mut bsc_type);
        (user, companion_a, companion_b, rule_set_id, service_fee, deposit_per_companion, platform_fee_bps, status, team_status, created_at, finish_at, dispute_deadline, vault_service, vault_deposit_a, vault_deposit_b, evidence_hash, dispute_status, resolved_by, resolved_at)
    }

    public(package) fun set(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, user: address, companion_a: address, companion_b: address, rule_set_id: u64, service_fee: u64, deposit_per_companion: u64, platform_fee_bps: u64, status: u8, team_status: u8, created_at: u64, finish_at: u64, dispute_deadline: u64, vault_service: u64, vault_deposit_a: u64, vault_deposit_b: u64, evidence_hash: vector<u8>, dispute_status: u8, resolved_by: address, resolved_at: u64, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value_tuple = encode(user, companion_a, companion_b, rule_set_id, service_fee, deposit_per_companion, platform_fee_bps, status, team_status, created_at, finish_at, dispute_deadline, vault_service, vault_deposit_a, vault_deposit_b, evidence_hash, dispute_status, resolved_by, resolved_at);
        dapp_system::set_record(dapp_hub, dapp_key::new(), key_tuple, value_tuple, resource_account, OFFCHAIN, ctx);
    }

    public fun get_struct(dapp_hub: &DappHub, resource_account: String, order_id: u64): DuoOrder {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value_tuple = dapp_system::get_record<DappKey>(dapp_hub, resource_account, key_tuple);
    ...
    public(package) fun set_struct(dapp_hub: &mut DappHub, resource_account: String, order_id: u64, duo_order: DuoOrder, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&order_id));
        let value_tuple = encode_struct(duo_order);
        dapp_system::set_record(dapp_hub, dapp_key::new(), key_tuple, value_tuple, resource_account, OFFCHAIN, ctx);
    }

    public fun encode(user: address, companion_a: address, companion_b: address, rule_set_id: u64, service_fee: u64, deposit_per_companion: u64, platform_fee_bps: u64, status: u8, team_status: u8, created_at: u64, finish_at: u64, dispute_deadline: u64, vault_service: u64, vault_deposit_a: u64, vault_deposit_b: u64, evidence_hash: vector<u8>, dispute_status: u8, resolved_by: address, resolved_at: u64): vector<vector<u8>> {
        let mut value_tuple = vector::empty();
        value_tuple.push_back(to_bytes(&user));
        value_tuple.push_back(to_bytes(&companion_a));
        value_tuple.push_back(to_bytes(&companion_b));
        value_tuple.push_back(to_bytes(&rule_set_id));
        value_tuple.push_back(to_bytes(&service_fee));
        value_tuple.push_back(to_bytes(&deposit_per_companion));
        value_tuple.push_back(to_bytes(&platform_fee_bps));
        value_tuple.push_back(to_bytes(&status));
        value_tuple.push_back(to_bytes(&team_status));
        ...
        value_tuple.push_back(to_bytes(&vault_deposit_a));
        value_tuple.push_back(to_bytes(&vault_deposit_b));
    ...
    public fun encode_struct(duo_order: DuoOrder): vector<vector<u8>> {
        encode(duo_order.user, duo_order.companion_a, duo_order.companion_b, duo_order.rule_set_id, duo_order.service_fee, duo_order.deposit_per_companion, duo_order.platform_fee_bps, duo_order.status, duo_order.team_status, duo_order.created_at, duo_order.finish_at, duo_order.dispute_deadline, duo_order.vault_service, duo_order.vault_deposit_a, duo_order.vault_deposit_b, duo_order.evidence_hash, duo_order.dispute_status, duo_order.resolved_by, duo_order.resolved_at)
    }

    public fun decode(data: vector<u8>): DuoOrder {
