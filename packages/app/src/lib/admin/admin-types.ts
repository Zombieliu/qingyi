...
export type LiveStatus = "待审核" | "面试中" | "已通过" | "已拒绝";
...
export interface AdminLiveApplication {
  id: string;
  user?: string;
  userAddress?: string;
  contact?: string;
...
export interface AdminStore {
  ...
  liveApplications: AdminLiveApplication[];
...
export const LIVE_STATUS_OPTIONS: LiveStatus[] = ["待审核", "面试中", "已通过", "已拒绝"];
