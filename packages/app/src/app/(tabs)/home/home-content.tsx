...
const quickActions = [
  {
    label: t("tabs.home.home_content.i001"),
    desc: t("tabs.home.home_content.i002"),
    href: "/schedule",
    icon: Sparkles,
    tone: "primary",
  },
  {
    label: t("tabs.home.home_content.i003"),
    desc: t("tabs.home.home_content.i004"),
    href: "/schedule",
    icon: Gift,
    tone: "rose",
  },
  {
    label: t("tabs.home.home_content.i005"),
    desc: t("tabs.home.home_content.i006"),
    href: "/vip",
    icon: Crown,
    tone: "gold",
  },
  {
    label: t("tabs.home.home_content.i007"),
    desc: t("tabs.home.home_content.i008"),
    href: "/me/support",
    icon: Headset,
    tone: "teal",
  },
...
const packages = [
  {
    name: t("tabs.home.home_content.i009"),
    desc: t("tabs.home.home_content.i010"),
    price: "¥88",
    numPrice: 88,
    tag: t("tabs.home.home_content.i011"),
    eta: t("tabs.home.home_content.i012"),
    category: t("tabs.home.home_content.i013"),
    highlight: true,
  },
  {
    name: t("tabs.home.home_content.i014"),
    desc: t("tabs.home.home_content.i015"),
    price: "¥128",
    numPrice: 128,
    tag: t("tabs.home.home_content.i016"),
    eta: t("tabs.home.home_content.i017"),
    category: t("tabs.home.home_content.i018"),
  },
  {
    name: t("ui.home-content.628"),
    desc: t("ui.home-content.639"),
    price: t("tabs.home.home_content.i019"),
    numPrice: 30,
    tag: t("tabs.home.home_content.i020"),
    eta: t("tabs.home.home_content.i021"),
    category: t("tabs.home.home_content.i022"),
  },
  {
    name: t("ui.home-content.630"),
    desc: t("ui.home-content.555"),
    price: t("tabs.home.home_content.i023"),
    numPrice: 60,
    tag: t("tabs.home.home_content.i024"),
    eta: t("tabs.home.home_content.i025"),
    category: t("tabs.home.home_content.i026"),
  },
];
...
const assurances = [
  {
    title: t("tabs.home.home_content.i027"),
    desc: t("tabs.home.home_content.i028"),
    icon: ShieldCheck,
  },
  {
    title: t("tabs.home.home_content.i029"),
    desc: t("tabs.home.home_content.i030"),
    icon: Clock3,
  },
  {
    title: t("tabs.home.home_content.i031"),
    desc: t("tabs.home.home_content.i032"),
    icon: Headset,
  },
];
