    ...
    items: [
      {
        ...
        eta: t("tabs.schedule.schedule_data.i051"),
        price: t("tabs.schedule.schedule_data.i052"),
        base: 30,
      },
      {
        ...
        price: t("tabs.schedule.schedule_data.i053"),
        base: 60,
      },
      {
        name: t("ui.schedule-data.645"),
        desc: t("ui.schedule-data.708"),
        eta: t("tabs.schedule.schedule_data.i054"),
        price: t("tabs.schedule.schedule_data.i055"),
        base: 50,
      },
      {
        ...
        price: t("tabs.schedule.schedule_data.i056"),
        base: 100,
      },
    ],
  },
    ...
    items: [
      {
        ...
        price: t("tabs.schedule.schedule_data.i057"),
        base: 588,
      },
      {
        ...
        price: t("tabs.schedule.schedule_data.i058"),
        base: 1288,
      },
    ],
  },
