...
export function ConfirmDialog({
  ...
  title,
  description,
  confirmLabel = t("components.confirm_dialog.i152"),
  cancelLabel = t("components.confirm_dialog.i153"),
  busy,
  onConfirm,
  onClose,
  children,
...
export function PromptDialog({
  ...
  placeholder,
  value,
  confirmLabel = t("components.confirm_dialog.i154"),
  cancelLabel = t("components.confirm_dialog.i155"),
  busy,
  onChange,
  onConfirm,
  onClose,
