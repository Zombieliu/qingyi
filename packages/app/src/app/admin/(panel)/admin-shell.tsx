...
const navItems: NavItem[] = [
  { href: "/admin", label: t("ui.admin-shell.693"), icon: LayoutGrid, minRole: "viewer" },
  {
    ...
    label: t("admin.panel.admin_shell.i004"),
    icon: Activity,
    minRole: "viewer",
  },
  ...
  {
    href: "/admin/coupons",
    label: t("admin.panel.admin_shell.i005"),
    icon: TicketPercent,
    minRole: "ops",
  },
  {
    href: "/admin/redeem",
    label: t("admin.panel.admin_shell.i006"),
    icon: KeyRound,
    minRole: "ops",
  },
  ...
  { href: "/admin/examiners", label: t("ui.admin-shell.704"), icon: BadgeCheck, minRole: "ops" },
  { href: "/admin/live-applications", label: t("ui.admin-shell.706"), icon: Radio, minRole: "ops" },
  {
  ...
  { href: "/admin/referral", label: t("admin.panel.admin_shell.i007"), icon: Gift, minRole: "ops" },
  { href: "/admin/analytics", label: t("ui.admin-shell.567"), icon: TrendingUp, minRole: "admin" },
  {
    href: "/admin/revenue",
    label: t("admin.panel.admin_shell.i008"),
    icon: BarChart3,
    minRole: "admin",
  },
  {
    href: "/admin/earnings",
    label: t("admin.panel.admin_shell.i009"),
    icon: BarChart3,
    minRole: "finance",
  },
  ...
  {
    href: "/admin/mantou",
    label: t("admin.panel.admin_shell.i010"),
    icon: Wallet,
    minRole: "finance",
  },
  {
    href: "/admin/invoices",
    label: t("admin.panel.admin_shell.i011"),
    icon: FileCheck,
    minRole: "finance",
  },
  {
    href: "/admin/chain",
    label: t("admin.panel.admin_shell.i012"),
    icon: Link2,
    minRole: "finance",
  },
  {
    href: "/admin/payments",
    label: t("admin.panel.admin_shell.i013"),
    icon: CreditCard,
    minRole: "finance",
  },
  {
    href: "/admin/reconcile",
    label: t("admin.panel.admin_shell.i014"),
    icon: Scale,
    minRole: "finance",
  },
  {
    href: "/admin/audit",
    label: t("admin.panel.admin_shell.i015"),
    icon: FileText,
    minRole: "admin",
  },
  {
    href: "/admin/tokens",
    label: t("admin.panel.admin_shell.i016"),
    icon: KeyRound,
    minRole: "admin",
  },
];
...
const subtitles: Record<string, string> = {
  ...
  "/admin/examiners": t("ui.admin-shell.705"),
  "/admin/live-applications": t("ui.admin-shell.707"),
  "/admin/announcements": t("ui.admin-shell.539"),
  "/admin/referral": t("admin.panel.admin_shell.i017"),
  "/admin/redeem": t("admin.panel.admin_shell.i018"),
  "/admin/analytics": t("ui.admin-shell.673"),
  "/admin/dashboard": t("admin.panel.admin_shell.i019"),
  "/admin/revenue": t("admin.panel.admin_shell.i020"),
  "/admin/earnings": t("admin.panel.admin_shell.i021"),
  ...
  "/admin/tokens": t("admin.panel.admin_shell.i022"),
};
